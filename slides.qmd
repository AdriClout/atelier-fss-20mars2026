...
mots <- reponses |> unnest_tokens(mot, texte)
data(stop_words)
mots_propres <- mots |> anti_join(stop_words, by = c("mot" = "word"))
...
[**GitHub Student Developer Pack**](https://education.github.com/pack) — compte GitHub avec adresse universitaire → Copilot + dizaines d'outils gratuits.
:::
::: {.column width="33%"}
**Google Gemini**
...
[**Google Workspace for Education**](https://edu.google.com/intl/ALL_ca/workspace-for-education/gemini/) — Gemini Advanced souvent inclus. Sinon : [gemini.google.com](https://gemini.google.com) gratuit.
:::
::: {.column width="33%"}
**DataCamp**
...
[**Activer l'accès gratuit →**](https://www.datacamp.com/groups/shared_links/eb5c78c872a775f17d2d2434b1ecd255b594b2c31ad701348869257e693c8515)
:::
:::
...
-   [DataCamp](https://www.datacamp.com/groups/shared_links/eb5c78c872a775f17d2d2434b1ecd255b594b2c31ad701348869257e693c8515) — cours interactifs R, Python, SQL *(accès gratuit via le lien partagé)*
...
-   [Claude](https://claude.ai), [ChatGPT](https://chatgpt.com), [Gemini](https://gemini.google.com) — assistants de code
-   Règle d'or : toujours valider le code avant de faire confiance aux résultats

## Le contenu de cet atelier est sur GitHub

::: {.r-fit-text}
**[github.com/AdriClout/atelier-fss-20mars2026](https://github.com/AdriClout/atelier-fss-20mars2026)**
:::
