...
## Outils IA — accès gratuit pour les étudiants 🎓

::: {.columns}
::: {.column width="50%"}
**GitHub Copilot**

IA intégrée à l'éditeur — complète votre code en temps réel.

**Gratuit via le [GitHub Student Developer Pack](https://education.github.com/pack) :**

1. Compte GitHub avec adresse universitaire
2. Demander le Student Pack
3. Activer dans Positron ou VS Code
:::
::: {.column width="50%"}
**Google Gemini**

Assistant conversationnel puissant pour générer, expliquer et déboguer du code.

**Accès gratuit pour les étudiants :**

- [**Google for Students**](https://edu.google.com/intl/ALL_ca/workspace-for-education/gemini/) — Gemini Advanced inclus avec Google Workspace for Education
- Ou [gemini.google.com](https://gemini.google.com) (version gratuite déjà très capable)
:::
:::
